...
fetch open pull requests. A new window listing them will open automatically.
You can load previously merged pull requests with **Load Merged PRs** or
reopen the list using **View PR List**.
