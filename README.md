...
The main window displays a status line showing progress with percentages when
loading repositories, pull requests or branches. Branch lists are cached per
repository to avoid fetching them repeatedly.
